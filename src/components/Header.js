...
export const Header = () => {
    ...
    return (
        <header>
            <nav className="px-2 py-2 bg-white border-b-2 border-gray-200 sm:px-4 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    <Link to="/" className="flex items-center">
                        <img src={Logo} className="h-6 mr-2 sm:h-9" alt="Cinemate Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kino Afish</span>
                    </Link>
                    ...
                    <div className={`${hidden ? "hidden" : ""} justify-between items-center w-full md:flex md:w-auto md:order-1`} id="navbar-search">
                        ...
                        <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <NavLink to="/movies/discover" className={({ isActive }) => (isActive ? activeClass : inActiveClass)}>
                                    Discover
                                </NavLink>
                            </li>
                        </ul>
