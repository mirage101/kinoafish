...
export const Card = ({ movie }) => {
    ...
    const reversedDate = new Date(release_date).toLocaleDateString(undefined, {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
    });
    ...
    return (
        <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-3">
            ...
            <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Release date: {reversedDate}</p>
            </div>
        </div>
    );
};
